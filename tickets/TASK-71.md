...
## Acceptance Criteria
- [ ] Se documenta si Tarjeta Sanitaria y Tarjeta Biblioteca son carnets digitales reales, accesos rápidos a otros módulos o elementos descartados del MVP.
- [ ] Se define su relación con CIP/salud y con el catálogo de carnets del EPIC-7.
- [ ] Se deja trazado el impacto sobre STORY-22, STORY-31 y STORY-48.
- [ ] Se documenta la decisión de producto/backend necesaria si no existe contrato ni diseño detallado adicional.

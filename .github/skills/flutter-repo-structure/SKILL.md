...
description: Apply the Flutter canon for repository topology, app bootstrap, core capabilities, environment entrypoints, AppConfig, and dependency boundaries. Use when creating or refactoring lib/app, lib/core, lib/l10n, config/, or main_<env>.dart files.

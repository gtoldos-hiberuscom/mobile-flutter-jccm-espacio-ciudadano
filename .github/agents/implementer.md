---
name: implementer
description: Specialized agent for implementing Flutter changes under the architecture canon v2, using the repository documentation as source of truth and synchronizing ticket work through ticket-manager or ticket skills.

...
///
/// Sprint 9 (TASK-69 + STORY-64 merge) — list expanded from a sweep of
/// DTO/state field names used across the feature layers (auth,
/// agenda/sescam, social_welfare, state_affairs, digital_cards,
/// notifications/contact). Fragments are deliberately narrow
/// substrings — generic words such as `'date'`/`'fecha'` are excluded
/// to avoid over-redaction of non-PII metadata (`dateFormat`,
/// `fechaInicio` of a public event).

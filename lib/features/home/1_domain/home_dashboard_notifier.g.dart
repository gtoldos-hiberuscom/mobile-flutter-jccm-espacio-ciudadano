...
/// timestamps and counters stay fresh — `keepAlive: false` (the default
/// from `@riverpod`) is exactly the right semantic here.
final class HomeDashboardNotifierProvider extends $AsyncNotifierProvider<HomeDashboardNotifier, HomeDashboardSnapshot> {
  /// Riverpod async notifier that owns the authenticated home dashboard state.
  ///
  /// ## Lifecycle
  /// - On `build()`, asks the home dashboard repository for a snapshot and
...
String _$homeDashboardNotifierHash() => r'a5373a501633e3b3f9d1df45a6e14bc843e80440';
...
abstract class _$HomeDashboardNotifier extends $AsyncNotifier<HomeDashboardSnapshot> {
  FutureOr<HomeDashboardSnapshot> build();
  @$mustCallSuper
  @override
  void runBuild() {
    final created = build();
    final ref = this.ref as $Ref<AsyncValue<HomeDashboardSnapshot>, HomeDashboardSnapshot>;
    final element = ref.element as $ClassProviderElement<AnyNotifier<AsyncValue<HomeDashboardSnapshot>, HomeDashboardSnapshot>, AsyncValue<HomeDashboardSnapshot>, Object?, Object?>;

...
mixin _$AuthUser {
 ...
 String get sub; String? get nif; String? get givenName; String? get familyName; String? get email;
...
@override
int get hashCode => Object.hash(runtimeType,sub,nif,givenName,familyName,email);

@override
String toString() {
  return 'AuthUser(sub: $sub, nif: $nif, givenName: $givenName, familyName: $familyName, email: $email)';
}
...
@useResult
$Res call({
 String sub, String? nif, String? givenName, String? familyName, String? email
});
...
/// Create a copy of AuthUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sub = null,Object? nif = freezed,Object? givenName = freezed,Object? familyName = freezed,Object? email = freezed,}) {

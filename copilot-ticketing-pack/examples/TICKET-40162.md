...
- Allow pre-filling the user’s postal code.
- Auto-fill the postal code if the data is available.
- Allow the user to manually edit the postal code.
- Improve the visibility of branch information.
- Make the branch information expanded by default, or redesign the area so that it is more intuitive and visible.
- Improve the map pin or marker.
...
- [ ] The branch pin on the map meets visibility criteria for size, contrast, and position.
...
## Notes
### Comments
- 2026-04-20T07:55:53.997Z | author: Copilot | comment: Initial ticket import from Jira-like payload.

### Change Log
- 2026-04-20T07:55:53.997Z | creation | Ticket file created | by Copilot

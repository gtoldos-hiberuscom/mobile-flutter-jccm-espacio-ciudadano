...
class ProcedimientoApi {
  ...
  Future<Response<RESULTADOPROCEDIMIENTO>> hashAdjuntoaOperation({
    ...
    final _path = r'/api/v1/procedimiento/obtenerhashdeadjunto';
    ...
    RESULTADOPROCEDIMIENTO? _responseData;
    ...
    return Response<RESULTADOPROCEDIMIENTO>(
      data: _responseData,
  ...
  Future<Response<RESULTADOPROCEDIMIENTO>> miConfirmarProcOperation({
    ...
    final _path = r'/api/v1/procedimiento/miconfirmarproc';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RESULTADOPROCEDIMIENTO>> miIniProcOperation({
    ...
    final _path = r'/api/v1/procedimiento/inicproc';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ZCSRMOBTRESPUESTAEXPResponse>> miObtenerRespuestaOperation({
    ...
    final _path = r'/api/v1/procedimiento/miobtenerres';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ZCSRMOBTRESPUESTAEXPResponse? _responseData;
    ...
    return Response<ZCSRMOBTRESPUESTAEXPResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RESULTADOPROCEDIMIENTO>> miSubirAdjuntoOperation({
    ...
    final _path = r'/api/v1/procedimiento/subiradjunto';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RESULTADOPROCEDIMIENTO>> miSubirAdjuntoSinFirmaOperation({
    ...
    final _path = r'/api/v1/procedimiento/subiradjuntosinfirma';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,

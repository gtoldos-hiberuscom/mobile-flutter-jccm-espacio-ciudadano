...
/// * [tipodoc]
@BuiltValue()
abstract class DTEDUTUOREQ implements Built<DTEDUTUOREQ, DTEDUTUOREQBuilder> {
  ...
  factory DTEDUTUOREQ([void updates(DTEDUTUOREQBuilder b)]) = _$DTEDUTUOREQ;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DTEDUTUOREQBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DTEDUTUOREQ> get serializer => _$DTEDUTUOREQSerializer();
}

class _$DTEDUTUOREQSerializer implements PrimitiveSerializer<DTEDUTUOREQ> {
  @override
  final Iterable<Type> types = const [DTEDUTUOREQ, _$DTEDUTUOREQ];

  @override
  final String wireName = r'DTEDUTUOREQ';
  ...
  void _deserializeProperties(
    ...
    required DTEDUTUOREQBuilder result,
  ...
  @override
  DTEDUTUOREQ deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DTEDUTUOREQBuilder();

...
abstract class DTINECDRFREQ implements Built<DTINECDRFREQ, DTINECDRFREQBuilder> {
  ...
  factory DTINECDRFREQ([void updates(DTINECDRFREQBuilder b)]) = _$DTINECDRFREQ;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DTINECDRFREQBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DTINECDRFREQ> get serializer => _$DTINECDRFREQSerializer();
}

class _$DTINECDRFREQSerializer implements PrimitiveSerializer<DTINECDRFREQ> {
  @override
  final Iterable<Type> types = const [DTINECDRFREQ, _$DTINECDRFREQ];

  @override
  final String wireName = r'DTINECDRFREQ';
  ...
  void _deserializeProperties(
    ...
    required DTINECDRFREQBuilder result,
  ...
  @override
  DTINECDRFREQ deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DTINECDRFREQBuilder();

...
part of 'dtedutnureq.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DTEDUTNUREQ extends DTEDUTNUREQ {
  @override
  final String? docu;
  @override
  ...
  factory _$DTEDUTNUREQ([void Function(DTEDUTNUREQBuilder)? updates]) =>
      (DTEDUTNUREQBuilder()..update(updates))._build();
  ...
  _$DTEDUTNUREQ._(
      ...
      : super._();
  @override
  DTEDUTNUREQ rebuild(void Function(DTEDUTNUREQBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DTEDUTNUREQBuilder toBuilder() => DTEDUTNUREQBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DTEDUTNUREQ &&
        docu == other.docu &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DTEDUTNUREQ')
          ..add('docu', docu)
...
class DTEDUTNUREQBuilder implements Builder<DTEDUTNUREQ, DTEDUTNUREQBuilder> {
  _$DTEDUTNUREQ? _$v;
  ...
  DTEDUTNUREQBuilder() {
    DTEDUTNUREQ._defaults(this);
  }

  DTEDUTNUREQBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _docu = $v.docu;
  ...
  @override
  void replace(DTEDUTNUREQ other) {
    _$v = other as _$DTEDUTNUREQ;
  }

  @override
  void update(void Function(DTEDUTNUREQBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DTEDUTNUREQ build() => _build();

  _$DTEDUTNUREQ _build() {
    final _$result = _$v ??
        _$DTEDUTNUREQ._(
          docu: docu,

...
part of 'pregistro.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PREGISTRO extends PREGISTRO {
  @override
  ...
  factory _$PREGISTRO([void Function(PREGISTROBuilder)? updates]) =>
      (PREGISTROBuilder()..update(updates))._build();
  ...
  _$PREGISTRO._(
      ...
      : super._();
  @override
  PREGISTRO rebuild(void Function(PREGISTROBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PREGISTROBuilder toBuilder() => PREGISTROBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PREGISTRO &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PREGISTRO')
...
class PREGISTROBuilder implements Builder<PREGISTRO, PREGISTROBuilder> {
  _$PREGISTRO? _$v;
  ...
  PREGISTROBuilder() {
    PREGISTRO._defaults(this);
  }

  PREGISTROBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PREGISTRO other) {
    _$v = other as _$PREGISTRO;
  }

  @override
  void update(void Function(PREGISTROBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PREGISTRO build() => _build();

  _$PREGISTRO _build() {
    final _$result = _$v ??
        _$PREGISTRO._(
          apellido1: BuiltValueNullFieldError.checkNotNull(
              apellido1, r'PREGISTRO', 'apellido1'),
          apellido2: BuiltValueNullFieldError.checkNotNull(
              apellido2, r'PREGISTRO', 'apellido2'),
          asuid: BuiltValueNullFieldError.checkNotNull(
              asuid, r'PREGISTRO', 'asuid'),
          descrip: BuiltValueNullFieldError.checkNotNull(
              descrip, r'PREGISTRO', 'descrip'),
          idunico: BuiltValueNullFieldError.checkNotNull(
              idunico, r'PREGISTRO', 'idunico'),
          nombre: BuiltValueNullFieldError.checkNotNull(
              nombre, r'PREGISTRO', 'nombre'),
          numdoc: BuiltValueNullFieldError.checkNotNull(
              numdoc, r'PREGISTRO', 'numdoc'),
          uniorg: BuiltValueNullFieldError.checkNotNull(
              uniorg, r'PREGISTRO', 'uniorg'),
        );
    replace(_$result);
    return _$result;
  }

...
abstract class DTEDUTNUREQ implements Built<DTEDUTNUREQ, DTEDUTNUREQBuilder> {
  ...
  factory DTEDUTNUREQ([void updates(DTEDUTNUREQBuilder b)]) = _$DTEDUTNUREQ;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DTEDUTNUREQBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DTEDUTNUREQ> get serializer => _$DTEDUTNUREQSerializer();
}

class _$DTEDUTNUREQSerializer implements PrimitiveSerializer<DTEDUTNUREQ> {
  @override
  final Iterable<Type> types = const [DTEDUTNUREQ, _$DTEDUTNUREQ];

  @override
  final String wireName = r'DTEDUTNUREQ';
  ...
  void _deserializeProperties(
    ...
    required DTEDUTNUREQBuilder result,
  ...
  @override
  DTEDUTNUREQ deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DTEDUTNUREQBuilder();

...
void main() {
  group('AgendaEventTile (STORY-30)', () {
    ...
    testWidgets('expand toggle reveals inline detail and collapses again',
        (final tester) async {
      var taps = 0;
      ...
      expect(find.byKey(const ValueKey('agenda-tile-inline-detail')),
          findsNothing);
      ...
      expect(
          find.textContaining('Centro de Salud Talavera Centro'), findsOneWidget);
    ...
    testWidgets('event without detail fields renders chevron, no toggle',
        (final tester) async {
